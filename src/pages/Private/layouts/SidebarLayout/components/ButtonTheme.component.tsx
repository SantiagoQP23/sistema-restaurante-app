...
import { FormControlLabel, IconButton, Switch, styled, Typography, Stack } from '@mui/material';
...
export const ButtonTheme = () => {
  ...
  const curThemeName = localStorage.getItem('appTheme') || ThemeName.PureLightTheme;
    ...
    <>
      <Stack direction='row' alignItems='center' justifyContent='space-between' pl={2}>
        ...
        <MaterialUISwitch
          ...
          onChange={(e, value) => setNameTheme(value ? ThemeName.NebulaFighterTheme : ThemeName.PureLightTheme)}
        />
