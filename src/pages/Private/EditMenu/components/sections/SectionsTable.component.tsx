...
import { TableContainer, Table, TableHead, TableRow, TableCell, Checkbox, TableBody, Button, Card, useTheme, Box, TablePagination, Switch, IconButton } from '@mui/material';
import { usePagination } from "../../../../../hooks/usePagination"
import { useDispatch, useSelector } from "react-redux";
import { selectMenu, setActiveCategories, setActiveCategory, setActiveProducts, setActiveSection, updateSection } from '../../../../../redux/slices/menu/menu.slice';
...
export const SectionsTable = () => {
  ...
  const { rowsPerPage, page, handleChangePage, handleChangeRowsPerPage, paginatedList } = usePagination<ISection>(sections);
