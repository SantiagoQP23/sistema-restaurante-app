...
import { Box, FormControl, InputLabel, Select, MenuItem, Divider, 
  TableContainer, TableBody, TableRow, TableCell, Typography, IconButton,
  Table, Stack
} from "@mui/material";
      ...
      >
        ...
        >
          ...
          <Select
            ...
            onChange={(e) => setStatusPayFilter(e.target.value as OrderStatusPay)}
