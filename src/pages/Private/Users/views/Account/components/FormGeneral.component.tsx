...
import { Card, CardContent, Container, FormControl, Grid, InputLabel, MenuItem, Select, TextField, Typography } from "@mui/material"
...
export const FormGeneral = () => {
  ...
  const { register, handleSubmit, formState: { errors }, control, watch } = useForm<UpdateUserDto>({
    defaultValues: {
  ...
  const lengthIdentification = watch('typeIdentification') === TypeIdentification.CEDULA ? 10 : 13;
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <TextField
                    ...
                    ...register('numberIdentification', {
                      ...
                      minLength: { value: lengthIdentification, message: `Minimo ${lengthIdentification} caracteres` },
                      maxLength: { value: lengthIdentification, message: `Máximo ${lengthIdentification} caracteres` },


                    })
                    }
                    helperText={<Typography color="red">{errors.numberIdentification?.message} </ Typography>}
                  />
                </Grid>
