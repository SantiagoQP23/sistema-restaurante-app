...
import { Card, CardContent, TextField, Button, Container, FormControl, Alert, Stack } from '@mui/material';
import { useForm } from 'react-hook-form';
import { ChangePassword, ChangePasswordDto } from '../../../dto/change-password.dto';
              ...
              <TextField
                ...
                ...register('newPassword', {
                  ...
                  pattern: {
                    ...
                    message: 'Minimo 6 caracteres, al menos una letra mayúscula, una letra minúscula y un número'
                  }
                })

                }
                helperText={errors.newPassword?.message || 'Minimo 6 caracteres, al menos una letra mayúscula, una letra minúscula y un número'}
