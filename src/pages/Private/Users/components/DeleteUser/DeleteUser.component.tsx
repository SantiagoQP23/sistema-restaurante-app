...
import { deleteUser, selectUsers } from '../../../../../redux/slices/users/users.slice';
import { useSelector, useDispatch } from 'react-redux';
import { IUser } from '../../../../../models/auth.model';
import { statusModalDeleteUser, deleteUser as deleteUserS } from '../../services/users.service';
  ...
  return (
    <Dialog open={open} onClose={closeModal}>
        ...
        <DialogActions>
          ...
          <LoadingButton loading={loading} variant='contained' color='error' onClick={submitDeleteUser}>
            Aceptar
          </LoadingButton>
        </DialogActions>
      </Dialog>
