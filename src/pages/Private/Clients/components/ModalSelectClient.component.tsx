...
import { Dialog, DialogTitle, Typography, IconButton, List, ListItem, ListItemText, ListItemSecondaryAction, Button, Paper, InputBase, CircularProgress, DialogContent, Stack, Box } from '@mui/material';
...
export const ModalSelectClient: FC<Props> = ({
