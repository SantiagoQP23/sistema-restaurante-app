import { Card, CardHeader, Divider, List, ListItemButton, ListItemText, Box, Typography } from "@mui/material";
...
export const CardOrdersByStatus: FC<Props> = ({
  orders,
  title,
  color
}) => {
          ...
          {orders.map(order => (
              ...
              >
                <ListItemText
                    ...
                    <>
                      <Box display='flex' justifyContent='space-between' alignItems='center'>
                        <Box>
                          ...
                          <Typography variant='h5' >Mesa {order.table?.name}</Typography>
                        </Box>
                  ...
                  secondary={
                    <>
                      <Typography variant='body1'>{format(new Date(order.createdAt), 'dd MMMM HH:mm:ss', { locale: es })}</Typography>
                    </>
                  }
                />
