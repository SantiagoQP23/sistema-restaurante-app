...
export const SummaryTransfer:FC<Props> = ({cashRegister}) => {
  ...
  const balanceTransfer = cashRegister ? cashRegister.totalIncomesTransfer + cashRegister.totalInvoicesTransfer - cashRegister.totalExpensesTransfer : 0;
  return (
    <Card>
      ...
      >
        ...
        >
          ...
          <Box>
            ...
            <Typography variant='h4' color='success.main' >{formatMoney(cashRegister.totalIncomesTransfer)}</Typography>
          </Box>
          <Box>
            <Typography variant='caption' >Ventas</Typography>
            <Typography variant='h4' color='success.main' >{formatMoney(cashRegister.totalInvoicesTransfer)}</Typography>
          </Box>
          <Box>
            <Typography variant='caption' >Gastos</Typography>
            <Typography variant='h4' color='error.main' >{formatMoney(cashRegister.totalExpensesTransfer)}</Typography>
          </Box>
