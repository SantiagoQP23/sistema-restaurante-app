  ...
  return (
    <Document  >
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 2 }}>
          <Text style={{ textAlign: 'center', fontSize: 14, fontWeight: 'bold' }}>Ingresos</Text>
        ...
        <View>
          ...
          <Text style={{ fontSize: 12, marginBottom: 2 }}> Ingresos de Febrero  </Text>
        </View>
        ...
        {dates.map((day, index) => (
          <View key={index} style={{ flexDirection: 'row', borderWidth: 1, borderColor: 'black' }}>
            <View style={styles.column}>
              <Text style={styles.text}>{format(new Date(day.date), 'dd/MM/yyyy', {locale: es})}</Text>
            </View>
            <View style={styles.column}>
              <Text style={styles.text}>{format(new Date(day.date), 'EEEE', {locale: es})}</Text>
            </View>
        ...
        <View style={{ flexDirection: 'row', borderWidth: 1, borderColor: 'black' }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.text}>$ {dates.reduce((acc, curr) => acc + curr.total, 0)}</Text>
          </View>
        </View>
