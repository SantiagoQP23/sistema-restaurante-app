...
export const getFinances = async (filterDto: DateFiltePaginationDto): Promise<FinanceResponse[]> => {

  const { period, startDate, endDate, offset = 0, limit = 10, groupBy } = filterDto;
