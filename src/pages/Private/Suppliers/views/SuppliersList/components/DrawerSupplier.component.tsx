import { Drawer, useTheme, Box, Divider, IconButton, Stack, Typography, Button, FormControl, Grid, InputLabel, MenuItem, Select, TextField } from '@mui/material';
...
export const DrawerSupplier: FC<Props> = ({ supplier }) => {
  ...
  const { register, handleSubmit, formState: { errors }, control } = useForm<UpdateSupplierDto>({
  ...
  const lenghtIdentification = typeIdentification === TypeIdentification.CEDULA ? 10 : 13;
