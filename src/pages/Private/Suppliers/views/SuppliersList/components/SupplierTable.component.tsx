...
import { Card, CardHeader, IconButton, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow } from "@mui/material"
...

              {
                suppliersQuery.data?.map((supplier) => (
                  ...
                  >
                    ...
                    >
                      {supplier.person.firstName} {supplier.person.lastName} </TableCell>
