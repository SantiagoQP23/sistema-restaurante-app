import { Card, CardHeader, CardContent, FormControl, Grid, InputLabel, MenuItem, Select, TextField, Typography } from "@mui/material"
...
export const AddSupplier = () => {
  ...
  const { register, handleSubmit, formState: { errors }, control, reset } = useForm<CreateSupplierDto>()
